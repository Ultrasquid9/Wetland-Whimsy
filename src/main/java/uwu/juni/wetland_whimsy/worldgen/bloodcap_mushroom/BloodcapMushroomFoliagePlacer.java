...
public class BloodcapMushroomFoliagePlacer extends FoliagePlacer {
	public static final MapCodec<BloodcapMushroomFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(
		parts -> foliagePlacerParts(parts).apply(parts, BloodcapMushroomFoliagePlacer::new)
	);
