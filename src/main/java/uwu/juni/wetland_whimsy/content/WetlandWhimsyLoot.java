...
public class WetlandWhimsyLoot {
	public static LootTable.Builder createBasicLootTable() {
		return LootTable.lootTable()
			...
			.withPool(LootPool.lootPool()
				...
				.add(LootItem.lootTableItem(Items.TORCH.asItem()).apply(lootCount(1.F, 5.F)))
				...
				.add(LootItem.lootTableItem(Items.RAW_GOLD.asItem()).apply(lootCount(1.F, 6.F)))
				.add(LootItem.lootTableItem(Items.RAW_IRON.asItem()).apply(lootCount(1.F, 6.F)))
				.add(LootItem.lootTableItem(Items.RAW_COPPER.asItem()).apply(lootCount(1.F, 6.F)))
				.add(LootItem.lootTableItem(Items.GOLD_INGOT.asItem()).apply(lootCount(1.F, 3.F)))
				.add(LootItem.lootTableItem(Items.IRON_INGOT.asItem()).apply(lootCount(1.F, 3.F)))
				.add(LootItem.lootTableItem(Items.COPPER_INGOT.asItem()).apply(lootCount(1.F, 3.F)))
				...
				.add(LootItem.lootTableItem(Items.SLIME_BALL.asItem()).apply(lootCount(2.F, 6.F)))
				.add(LootItem.lootTableItem(Blocks.RED_MUSHROOM.asItem()).apply(lootCount(2.F, 6.F)))
				.add(LootItem.lootTableItem(Blocks.BROWN_MUSHROOM.asItem()).apply(lootCount(2.F, 6.F)))
				.add(LootItem.lootTableItem(WetlandWhimsyBlocks.BLOODCAP_MUSHROOM.asItem()).apply(lootCount(2.F, 6.F)))
				.add(LootItem.lootTableItem(WetlandWhimsyBlocks.ARIA_MUSHROOM.asItem()).apply(lootCount(2.F, 6.F)))
				...
				.add(LootItem.lootTableItem(Items.BOWL.asItem()).apply(stew()))
				...
				.add(LootItem.lootTableItem(Items.ARROW.asItem()).apply(lootCount(1.F, 4.F)))
				.add(LootItem.lootTableItem(Items.TIPPED_ARROW.asItem()).apply(lootCount(1.F, 3.F)).apply(potion("poison")))
			);
	}
	...
	public static LootTable.Builder createIntermediateLootTable() {
		return LootTable.lootTable()
			...
			.withPool(LootPool.lootPool()
				...
				.add(LootItem.lootTableItem(Items.ARROW.asItem()).apply(lootCount(1.F, 10.F)))
				.add(LootItem.lootTableItem(Items.TIPPED_ARROW.asItem()).apply(lootCount(1.F, 6.F)).apply(potion("poison")))
			);
	}
	...
	public static LootTable.Builder createEpicLootTable() {
		return LootTable.lootTable()
			...
			.withPool(LootPool.lootPool()
				.setRolls(UniformGenerator.between(1.F, 1.F))
				.add(LootItem.lootTableItem(Items.GOLDEN_CARROT.asItem()).apply(lootCount(6.F, 14.F)))
				...
				.add(LootItem.lootTableItem(Items.GOLD_INGOT.asItem()).apply(lootCount(7.F, 14.F)))
				.add(LootItem.lootTableItem(Items.IRON_INGOT.asItem()).apply(lootCount(7.F, 14.F)))
				.add(LootItem.lootTableItem(Items.COPPER_INGOT.asItem()).apply(lootCount(7.F, 14.F)))

				.add(LootItem.lootTableItem(Items.DIAMOND.asItem()).apply(lootCount(3.F, 6.F)))
				.add(LootItem.lootTableItem(Items.EMERALD.asItem()).apply(lootCount(7.F, 12.F)))
